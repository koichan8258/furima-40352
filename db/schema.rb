...
ActiveRecord::Schema[7.0].define(version: 2024_03_11_032102) do
  ...
  create_table "shipping_addresses", charset: "utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["record_id"], name: "index_shipping_addresses_on_record_id"
  end
  ...
  add_foreign_key "shipping_addresses", "records"
end
